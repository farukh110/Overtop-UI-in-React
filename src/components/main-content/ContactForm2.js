...
export const ContactForm2 = ({fname, lname, phone, email, address, city, GateCode, Services}) => {
    return (
        <>
          ...
          <div className="row">
            ...
            <input className="form-control" required type="text" placeholder={phone} />

            </div>

            <div className="col-lg-6 col-md-6 mt-md-3 mt-3">

            <input className="form-control" required type="email" placeholder={email} />
            ...
            <input className="form-control" required type="text" placeholder={GateCode} />

            </div>

            <div className="col-md-12 mt-md-3 mt-3">

            <textarea className="form-control" required rows="4" placeholder={Services}></textarea>
